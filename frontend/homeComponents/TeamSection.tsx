...
import TeamMember2 from "../public/assets/nimishaProfile.png";
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Meet the team of 3 people who are working on this project. I hope
        ...
        <div className="grid gap-8 lg:gap-16 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          <div className="text-center text-gray-500 dark:text-gray-400">
            ...
            <ul className="flex justify-center mt-4 space-x-4">
              <li>
                <Link
                  href="https://www.linkedin.com/in/ninadsrao/"
              ...
              <li>
                <Link
                  href="https://github.com/NinadRao0707"
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
            ...
            <ul className="flex justify-center mt-4 space-x-4">
              <li>
                <Link
                  href="https://www.linkedin.com/in/aamir-ansari-3b349b206"
                  className="text-[#39569c] hover:text-gray-900 dark:hover:text-white"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  href="https://github.com/Aamir-Ansari-almost"
                  className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300"
                >
                  <svg
                    className="w-6 h-6"
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
            ...
            <ul className="flex justify-center mt-4 space-x-4">
              <li>
                <Link
                  href="https://www.linkedin.com/in/nimisha-jain-1742b3214"
                  className="text-[#39569c] hover:text-gray-900 dark:hover:text-white"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  href="https://github.com/Nimishajain77"
                  className="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300"
                >
                  <svg
                    className="w-6 h-6"
